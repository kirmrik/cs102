...
from api import get_friends, get_last_name


def get_network(users_ids: List[int], as_edgelist: bool = True) -> Union[List[List[int]], List[Tuple[int, int]]]:
    ...
    """
    edgelist = []
    adj_matrix = [[0] * len(users_ids) for _ in range(len(users_ids))]
